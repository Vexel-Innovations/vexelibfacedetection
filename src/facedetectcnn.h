/*
 VexelLibFaceDetection - Core CNN Face Detection Engine
 Copyright (c) 2026, Vexel Innovations. All rights reserved.
 Licensed under the BSD 3-Clause License.
 
 High-performance CNN-based face detection with SIMD acceleration.
 Engineered by the Vexel Innovations team.
*/
